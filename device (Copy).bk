...
PRODUCT_ENFORCE_VINTF_MANIFEST := true
DEVICE_MANIFEST_FILE +=  vendor/realme/RE58C2/proprietary/vendor/etc/vintf/manifest/ai_engine-default.xml \
...
# ===========================
# EMERGENCY GRAPHICS FIXES - ADD THESE
# ===========================

PRODUCT_SYSTEM_PROPERTIES += \
    # Force software rendering to bypass crashing vendor graphics
...
PRODUCT_SYSTEM_PROPERTIES += \
    ...
    debug.sf.enable_hwc_vds=0 \  # DISABLED - can cause crashes
...
PRODUCT_PACKAGES += \
    ...
    hwcomposer.unisoc 
    # gralloc.default - REMOVED (using PRODUCT_COPY_FILES instead)

# ===========================
# GRAPHICS FILES - USE COPY FILES INSTEAD
# ===========================
...
# SELinux - Force device-specific vendor policies
PRODUCT_COPY_FILES += \
...
# Include in SEPolicy build
BOARD_SEPOLICY_UNION += \
    vendor_file_contexts \
    vendor_sepolicy.cil

# Temporary - set SELinux permissive for first boot
