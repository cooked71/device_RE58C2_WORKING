...
# ramdisk prebuild - ENABLED for single ramdisk approach
...
# ==================================================
# VENDOR BOOT CONFIGURATION - FIXED FOR SINGLE RAMDISK
# ==================================================

# CRITICAL FIX: Use single ramdisk approach like stock (no separate recovery ramdisk)
...
# Kernel arguments - FIXED: Added proper earlycon and removed dangerous parameters
BOARD_KERNEL_BASE := 0x00000000
BOARD_KERNEL_PAGESIZE := 4096
BOARD_KERNEL_CMDLINE := earlycon=sprd_serial,0x50850000,115200n8 console=ttyS1,115200n8 buildvariant=user
BOARD_KERNEL_CMDLINE += androidboot.selinux=permissive
# Debug - REMOVED: androidboot.init_fatal_panic=true as it causes immediate reboot on failures
BOARD_KERNEL_CMDLINE += loglevel=8 ignore_loglevel earlyprintk
...
# Individual partition sizes (EXACT stock geometry - CORRECTED for 4096 alignment):
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 2906112000     # 2.9 GB
BOARD_VENDORIMAGE_PARTITION_SIZE := 545177600      # 545 MB
BOARD_PRODUCTIMAGE_PARTITION_SIZE := 1612206080    # 1.6 GB
BOARD_SYSTEM_EXTIMAGE_PARTITION_SIZE := 563322880  # 563 MB
BOARD_ODMIMAGE_PARTITION_SIZE := 335970304         # 336 MB
BOARD_VENDOR_DLKMIMAGE_PARTITION_SIZE := 10485760  # 10.0 MB (adjusted)
...
# Recovery fstab
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/prebuilts/recovery.fstab
