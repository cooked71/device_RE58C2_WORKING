...
# Individual partition sizes (typical for A/B devices):
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 3221225472     # 3.0 GB
BOARD_VENDORIMAGE_PARTITION_SIZE := 805306368      # 0.75 GB
BOARD_PRODUCTIMAGE_PARTITION_SIZE := 1610612736    # 1.5 GB
BOARD_SYSTEM_EXTIMAGE_PARTITION_SIZE := 536870912   # 0.5 GB
