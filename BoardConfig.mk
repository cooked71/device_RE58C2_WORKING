...
BOARD_SUPER_PARTITION_SIZE := 8388608000  # 8.3 GB (keep original)
...
# 1. ROOT (System) partition: 892MB used + 136MB GApps + 50MB buffer = 1,078MB
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1132462080  # 1,080 MB

# 2. PRODUCT partition: 435MB used + 700MB GApps + 49MB buffer = 1,184MB  
BOARD_PRODUCTIMAGE_PARTITION_SIZE := 1241513984  # 1,184 MB

# 3. SYSTEM_EXT partition: 318MB used + 16MB GApps + 50MB buffer = 384MB
BOARD_SYSTEM_EXTIMAGE_PARTITION_SIZE := 402653184  # 384 MB

# 4. Other partitions (keep same, no GApps here)
BOARD_VENDORIMAGE_PARTITION_SIZE := 1073741824  # 1,024 MB (1.0GB)
BOARD_ODMIMAGE_PARTITION_SIZE := 459276288      # 438 MB
BOARD_VENDOR_DLKMIMAGE_PARTITION_SIZE := 25165824  # 24 MB
