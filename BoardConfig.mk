...
# Lineage 22.1
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1174405120     # 1120 MB (reduced from 1152 MB)
BOARD_PRODUCTIMAGE_PARTITION_SIZE := 1226833920    # 1170 MB (reduced from 1184 MB)  
BOARD_SYSTEM_EXTIMAGE_PARTITION_SIZE := 524288000  # 500 MB (increased from 384 MB)
BOARD_VENDORIMAGE_PARTITION_SIZE := 1191182336     # 1136 MB (reduced from 1152 MB)
BOARD_ODMIMAGE_PARTITION_SIZE := 503316480         # 480 MB (unchanged)
BOARD_VENDOR_DLKMIMAGE_PARTITION_SIZE := 31457280  # 30 MB (unchanged)
