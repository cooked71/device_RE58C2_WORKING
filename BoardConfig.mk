...
RECOVERY_MODULES := $(addprefix $(DEVICE_PATH)/prebuilts/modules_recovery_ramdisk/, $(BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD))
...
# Force super image building (CRITICAL)
...
# Development only: disable hashtree verification
...
# AVB signing for ALL partitions that have vbmeta_*.img counterparts
