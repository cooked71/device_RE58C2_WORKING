...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 2906112000     # 2.9 GB (aligned to 4096 bytes)
BOARD_VENDORIMAGE_PARTITION_SIZE := 545177600      # 545 MB (1064800 sectors × 512)
BOARD_PRODUCTIMAGE_PARTITION_SIZE := 1612206080    # 1.6 GB (3148840 sectors × 512)
BOARD_SYSTEM_EXTIMAGE_PARTITION_SIZE := 563322880  # 563 MB (1100240 sectors × 512)
BOARD_ODMIMAGE_PARTITION_SIZE := 335970304         # 336 MB (656192 sectors × 512)
BOARD_VENDOR_DLKMIMAGE_PARTITION_SIZE := 9793536   # 9.8 MB (19128 sectors × 512)
