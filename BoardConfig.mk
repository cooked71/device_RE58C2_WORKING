...
# Build image flags
BOARD_BUILD_SYSTEMIMAGE := true
BOARD_BUILD_VENDORIMAGE := true
BOARD_BUILD_PRODUCTIMAGE := true
BOARD_BUILD_SYSTEM_EXTIMAGE := true
BOARD_BUILD_ODMIMAGE := true
BOARD_BUILD_VENDOR_DLKMIMAGE := true
BOARD_BUILD_SUPER_IMAGE_BY_DEFAULT := true
BOARD_BUILD_DTBOIMAGE := true
